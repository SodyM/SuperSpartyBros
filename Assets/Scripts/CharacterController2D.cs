...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if (canDoubleJump && Input.GetButtonDown("Jump"))        // if can double jump and jump button pressed, allow double jump
        {
            DoJump();
            canDoubleJump = false;      // disable double jump since it's possible to do double jump only once
        }
